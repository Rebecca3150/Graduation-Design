								...
								if (data != null && data.length > 0) {
									...
									for ( var item in data) {
										...
										content += "<tr><td>"
												...
												+ "</td>"
												+ "<td>"
												+ "<a href='/project_management/PlanController/update/"
												+ data[item].planid
												+ ".action' onclick='return confirm(\'确认删除该计划？\');' class='text-primary'>删除</a></td>"
												+ "</tr>";
									}
				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title">
							...
							</span> <a href="#" class="text-primary">项目计划管理</a> / 计划执行 <br> <br>

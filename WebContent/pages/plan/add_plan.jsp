				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title">
							...
							</span> <a href="#" class="text-primary">项目计划管理</a> /计划编制
						</h3>
						<div class="col-sm-6">
							<c:if test="${status==0}">
								<div class="alert alert-success">
									<a href="#" class="close" data-dismiss="alert"> &times; </a> <strong>成功！</strong>生成项目计划编号：${planid }
								</div>
							</c:if>
							<c:if test="${status==1}">
								<div class="alert alert-danger">
									<a href="#" class="close" data-dismiss="alert"> &times; </a> <strong>失败！</strong>计划重复，请重试
								</div>
							</c:if>
						</div>
							...
							<div class="card">
								<div class="card-body">
									<form class="form-sample"
										...
										action="/project_management/PlanController/add/${user.userid }.action">
										<div class="row">
											<div class="col-md-6">
											...
											<div class="col-md-6">
												<div class="form-group row">
													<label class="col-sm-3 col-form-label">计划名称</label>
													<div class="col-sm-9">

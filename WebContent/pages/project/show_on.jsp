				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title">
							...
							</span> <a href="#" class="text-primary">项目信息管理</a> /未关闭项目
						</h3>
						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="row-fluid" align="right">
									...
									<div class="col-md-3">
										<div>
											<util:page pagingBean="${pagingBeanProjectOther1 }" />
										</div>
									</div>
								</div>
							</div>

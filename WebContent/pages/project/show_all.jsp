...
function showQuery(data) {
    ...
    if(data.state==0){
    	...
    	ue.setEnabled();
		$("#xiugai").attr("style","display:block;");
    }
    // 显示模态框
				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title">
							...
							</span> <a href="#" class="text-primary">项目信息管理</a> / 所有项目
						</h3>
						...
						<div class="col-md-12 grid-margin stretch-card">
							<div class="card">
													...
													<c:forEach items="${projects }" var="item">
														<tr>
																						...
																						<div class="row">
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="proid"
																											name="proid" readonly />
																									</div>
																								</div>
																							</div>
																						...
																						<div class="row">
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="userid1"
																											readonly />
																									</div>
																								</div>
																							</div>
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="userid2"
																											readonly />
																									</div>
																								</div>
																							</div>
																						...
																						<div class="row">
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="begindate"
																											readonly />
																									</div>
																								</div>
																							</div>
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="enddate"
																											readonly />
																									</div>
																								</div>
																							</div>
																						...
																						<div class="row">
																							<div class="col-md-6">
																								<div class="form-group row">
																									...
																									<div class="col-sm-8">
																										<input type="text"
																											class="form-control border-0" id="day"
																											readonly />
																									</div>
																								</div>
																							</div>
															...
															<td><c:if test="${item.state==1}">
																	<a
																		href="/project_management/ProjectController/update/${item.proid }/${user.userid }.action"
																		onclick="return confirm('确认关闭项目？');"
																		class="text-primary">关闭</a>
								...
								<div class="row-fluid" align="right">
									...
									<div class="col-md-3">
										<div>
											<util:page pagingBean="${pagingBeanProject }" />
										</div>
									</div>
								</div>
							</div>

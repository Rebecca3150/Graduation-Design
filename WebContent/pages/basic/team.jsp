...
<script type="text/javascript">
	function query(obj) {
		...
		if (obj != 0) {
			$
					.post(
							"/project_management/TeamController/showTeam.action",
							{
								proid : obj
								...
								if (data != null && data.length > 0) {
									...
									for ( var city in data) {
										content += "<tr><td>"
												...
												+ data[city].role
												+ "</td>"
												+ "<td><a href='/project_management/TeamController/update/"+obj+"/"+data[city].role+"/"+data[city].userid+".action' onclick='return confirm(\'确认删除该人员？\');' class='text-primary'>删除</a></td>"
												+ "</tr>";
									}
									$("#shows").append(content);
								} else {
									content = "<br><br><br><br><br> <center> <p class='text-primary'>别担心。<p >添加您自己或您的团队，我们将通知人员加入。</p></center>";
									$("#shows").append(content);
								}
							}, "json");
		}
				...
				<div class="content-wrapper">
					...
					<div class="page-header">
						<h3 class="page-title">
							...
							</span> <a href="#" class="text-primary">系统管理</a> / 团队管理 <br> <br> <select
								class="form-control" onchange="query(this.value)">
						...
						<div class="col-sm-6">
							<c:if test="${status==0}">
								<div class="alert alert-success">
									<a href="#" class="close" data-dismiss="alert"> &times; </a> <strong>成功！</strong>已添加人员
								</div>
							</c:if>
							<c:if test="${status==1}">
								<div class="alert alert-danger">
									<a href="#" class="close" data-dismiss="alert"> &times; </a> <strong>失败！</strong>未添加人员，请重试
								</div>
							</c:if>
							<c:if test="${state==0}">
								<div class="alert alert-success">
									<a href="#" class="close" data-dismiss="alert"> &times; </a> <strong>成功！</strong>已删除人员
								</div>
							</c:if>
							<c:if test="${state==1}">
								<div class="alert alert-danger">
					...
					<!-- 模态框——详情页 -->
					<div class="modal fade" id="queryTeam" tabindex="-1" role="dialog"
							...
							<div class="modal-content" style="width: 400px;">
								<div class="card">
									...
									<form role="form" method="post"
										action="/project_management/TeamController/add.action">
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<select class="form-control" id="userid" name="userid">
																<c:forEach items="${perusers }" var="item">
																	<!-- 这里需要所有的用户名称 -->
													...
													<div class="form-group row">
														...
														<div class="col-sm-9">
															<select class="form-control form-control-lg" id="role"
																...
																<option value="2">数据库人员</option>
																<option value="3">制图人员</option>
											...
											<div class="row">
												<div class="col-md-12">
													<p class="text-primary">
														当前项目ID：<input id="proid" name="proid" class="text-primary"
															style="border-style: solid; border-width: 0"
															value="请选择项目" readonly />
													</p>
												</div>
											</div>
											...
											<tbody id="shows">
												<c:forEach items="${userlist }" var="item">
													<tr>
														...
														<td>${item.role }</td>
														<td><a
															href="/project_management/TeamController/update/${proid }/${item.role }/${item.userid }.action"
															onclick="return confirm('确认删除该人员？');"
